...
const MissionAbout = () => {
  ...
  return (
    <div className=" text-[#2F4F4F] ">
      <h1 className="text-3xl max-[500px]:text-[23px] font-bold pb-3">
        {t("ABOUT.PAGE.VISION.title")}
      </h1>
      <List className="text-[18px] max-sm:text-[15px] leading-loose text-justify">
      ...
      <h1 className="text-3xl max-[500px]:text-[23px] font-bold pb-3">{t('ABOUT.PAGE.MISSION.title')}</h1>
      <List className="text-[18px] max-sm:text-[15px] leading-loose text-justify">
        <List.Item>
