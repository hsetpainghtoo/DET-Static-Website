...
const IntroItems = () => {
  ...
  return (
    <div className="flex max-lg:flex-col gap-14 pt-4 justify-center items-center">
      ...
      <img
        src={tech_company}
        className="w-[30%] max-lg:w-[40%] max-[800px]:w-[50%] max-sm:w-[60%] max-[450px]:w-[70%] lg:hidden pt-20 max-sm:pt-6 max-[550px]:pt-32 max-[420px]:mt-10 z-10 pb-20 max-lg:pb-0 max-sm:pb-10"
      />
      <img
        src={shape}
