...
const IntroService = () => {
  ...
  return (
    <div className="flex max-md:flex-col gap-14 pt-6 justify-center items-center">
      ...
      <img
        src={service}
        className="md:hidden w-[60%] mx-auto pt-28 max-sm:pt-32 max-[400px]:mt-10  z-10 "
      />
      ...
      <img
        ...
        src={shape}
        className="max-sm:hidden md:hidden max-md:-bottom-80 absolute  animate-[linear_bounceY_infinite_10s] w-[500px] max-sm:w-[400px]"
      />
