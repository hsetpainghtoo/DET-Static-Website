  ...
  return (
    <div className="flex max-md:flex-col gap-14 pt-6 justify-center items-center">
      <div className=" h-[300px] text-[#2F4F4F] w-[50%] max-md:w-[90%] max-sm:w-[95%] p-8">
        <h1 className="text-4xl max-lg:text-[32px] max-md:text-4xl max-[670px]:text-[40px] max-sm:text-[31px] leading-normal max-md:leading-tight max-sm:leading-[3rem]  font-bold mb-7 ">
      ...
      <img
        src={service}
        className="md:hidden w-[60%] mx-auto mt-28  max-[400px]:mt-40  z-10 "
      />
      ...
      <img
        ...
        src={shape}
        className="max-sm:hidden md:hidden max-md:-bottom-32 absolute  animate-[linear_bounceY_infinite_10s] w-[500px] max-sm:w-[400px]"
      />
      ...
      <img
        src={shape}
        className=" absolute max-md:hidden right-1  animate-[linear_bounceY_infinite_10s] w-[600px] max-xl:w-[500px] max-lg:w-[350px]"
      />
    </div>
  );
};
