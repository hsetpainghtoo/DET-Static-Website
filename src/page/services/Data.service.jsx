...
const DataService = () => {
  ...
  return (
    <div className=" text-[#2F4F4F]">
      <h1 className="text-4xl max-sm:text-3xl max-[500px]:text-[23px] font-bold pb-5">
        {t("SERVICE_PAGE.CONDUCTING.title_1")}
      </h1>
      <p className="text-xl max-sm:text-[15px] max-[500px]:text-[13px] text-justify leading-loose indent-9">
