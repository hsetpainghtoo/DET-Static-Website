    ...
    <div className=" pt-8 md:pt-12 pb-10 text-[#2F4F4F]">
      ...
      <section id="experience" className="experience ">
        <div className="customScrollbar scroll-smooth  w-[90%] h-[688px] mx-auto  rounded-lg overflow-y-scroll  md:p-10">
          <span className="indent-10 text-justify block text-xl max-sm:text-[13px] leading-8 xl:leading-10">
          ...
          <List className="text-[#2F4F4F] list-square ml-[4rem] xl:ml-[7rem] mt-5 xl:mt-[2rem] text-xl max-sm:text-[13px] leading-loose xl:leading-[3rem]">
          ...
          <List className="text-[#2F4F4F] list-square ml-[4rem] xl:ml-[7rem] mt-5 xl:mt-[2rem] text-xl max-sm:text-[13px] leading-8 xl:leading-[3rem]">
          ...
          <span className="indent-8 text-justify block mt-5 xl:mt-[2rem] text-xl max-sm:text-[13px] leading-8 xl:leading-10">
            {t("SERVICE_PAGE.EXPERIENCE.desc_2_1")}
          </span>
          <span className="indent-8 text-justify block mt-5 xl:mt-[2rem] text-xl max-sm:text-[13px] leading-8 xl:leading-10">
            {t("SERVICE_PAGE.EXPERIENCE.desc_2_2")}
          </span>
          <span className="indent-8 text-justify block mt-5 ml:mt-[2rem] text-xl max-sm:text-[13px] leading-8 xl:leading-10">
          ...
          <span className="indent-8 text-justify block mt-8 xl:mt-[3rem] text-xl max-sm:text-[13px] leading-8 xl:leading-10">
          ...
          <List className="text-[#2F4F4F] list-square ml-[4rem] xl:ml-[7rem] mt-5 xl:mt-[2rem] text-xl max-sm:text-[13px] leading-9 xl:leading-[3rem]">
          ...
          <span className="indent-8 text-justify block mt-9 xl:mt-[3rem] text-xl max-sm:text-[13px] leading-8 xl:leading-10">
