  ...
  return (
    <div className=" pt-8 md:pt-12 pb-10 text-[#2F4F4F]">
      <div className="flex px-11">
        ...
        <img
          src="public\assets\detlogo.png"
          className="w-[30%] max-lg:w-[50%] max-md:w-[60%] max-sm:w-[70%] "
        />
        <HR.Trimmed className="bg-[#003366] w-[20%] max-sm:w-[10%] max-sm:mt-7 max-md:mt-12 mt-2" />
      </div>
      <h1 className="w-[90%] mx-auto text-[#2F4F4F] leading-loose text-center text-3xl xl:text-4xl p-3 xl:p-4 font-bold ">
      ...
      <section id="experience" className="experience ">
        <div className="customScrollbar scroll-smooth  w-[90%] h-[688px] mx-auto  rounded-lg overflow-y-scroll  md:p-10">
          <span className="indent-10 text-justify block text-xl max-sm:text-[15px] leading-8 xl:leading-10">
            {t("SERVICE_PAGE.EXPERIENCE.DESC")}
          </span>
          <span className="block max-xl:leading-loose text-xl xl:mt-[2rem] xl:text-3xl font-semibold xl:font-bold">
            {t("SERVICE_PAGE.EXPERIENCE.title_1")}
          </span>
          <List className="text-[#2F4F4F] list-square ml-[4rem] xl:ml-[7rem] mt-5 xl:mt-[2rem] text-xl max-sm:text-[15px] leading-loose xl:leading-[3rem]">
          ...
          <span className="block leading-loose mt-5 xl:mt-[2rem] text-xl xl:text-[33px] font-semibold xl:font-bold">
            {t("SERVICE_PAGE.EXPERIENCE.title_2")}
          </span>
          <List className="text-[#2F4F4F] list-square ml-[4rem] xl:ml-[7rem] mt-5 xl:mt-[2rem] text-xl max-sm:text-[15px] leading-8 xl:leading-[3rem]">
          ...
          <span className="indent-8 text-justify block mt-5 xl:mt-[2rem] text-xl max-sm:text-[15px] leading-8 xl:leading-10">
            {t("SERVICE_PAGE.EXPERIENCE.desc_2_1")}
          </span>
          <span className="indent-8 text-justify block mt-5 xl:mt-[2rem] text-xl max-sm:text-[15px] leading-8 xl:leading-10">
            {t("SERVICE_PAGE.EXPERIENCE.desc_2_2")}
          </span>
          <span className="indent-8 text-justify block mt-5 ml:mt-[2rem] text-xl max-sm:text-[15px] leading-8 xl:leading-10">
            {t("SERVICE_PAGE.EXPERIENCE.desc_2_3")}
          </span>

          <h1 className="leading-loose text-center text-2xl xl:text-4xl font-bold mt-[2rem] xl:mt-[5rem]">
            {t("SERVICE_PAGE.EXPERIENCE.title_3")}
          </h1>
          <span className="indent-8 text-justify block mt-8 xl:mt-[3rem] text-xl max-sm:text-[15px] leading-8 xl:leading-10">
          ...
          <List className="text-[#2F4F4F] list-square ml-[4rem] xl:ml-[7rem] mt-5 xl:mt-[2rem] text-xl max-sm:text-[15px] leading-9 xl:leading-[3rem]">
          ...
          <span className="indent-8 text-justify block mt-9 xl:mt-[3rem] text-xl max-sm:text-[15px] leading-8 xl:leading-10">
