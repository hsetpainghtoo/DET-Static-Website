...
const ExperienceService = () => {
  ...
  return (
    <div className=" pt-8 md:pt-12 pb-10 text-[#2F4F4F]">
      ...
      <h1 className="w-[90%] mx-auto text-[#2F4F4F] leading-normal text-center text-3xl xl:text-4xl p-3 xl:p-4 font-bold ">
      ...
      <section id="experience" className="experience">
        <div className="customScrollbar scroll-smooth  w-[90%] h-[688px] mx-auto  rounded-lg overflow-y-scroll  md:p-10">
          ...
          <span className="block leading-normal text-xl xl:mt-[2rem] xl:text-3xl font-semibold xl:font-bold">
          ...
          <span className="block leading-normal mt-5 xl:mt-[2rem] text-xl xl:text-[33px] font-semibold xl:font-bold">
          ...
          <h1 className="leading-normal text-center text-2xl xl:text-4xl font-bold mt-[2rem] xl:mt-[5rem]">
