...
const BenefitsService = () => {
  ...
  return (
    <div className="text-[#2F4F4F] ">
      <h1 className="text-center text-4xl max-sm:text-3xl font-bold leading-loose">
      ...
      <div className="flex max-md:flex-col gap-4">
        <img
          src="public\assets\Benefits.svg"
      ...
      <p className="text-xl max-sm:text-[15px] max-md:w-[95%] mx-auto leading-loose pt-3 text-justify indent-9">
