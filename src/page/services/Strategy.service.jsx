...
const StrategyService = () => {
  ...
  return (
    <div className=" text-[#2F4F4F]">
      <h1 className="text-[35.5px] max-sm:text-3xl leading-loose font-bold pb-4">
        {t("SERVICE_PAGE.STRATEGY.title_1")}
      </h1>
      <p className="text-xl max-sm:text-[14px] leading-loose text-justify indent-9">
        {t("SERVICE_PAGE.STRATEGY.desc_1")}
      </p>

      <HR.Trimmed className="bg-[#003366] w-[60%] my-9" />

      <h1 className="text-4xl max-sm:text-3xl font-bold pb-4">
        {t("SERVICE_PAGE.STRATEGY.title_2")}
      </h1>
      <div className="text-xl max-sm:text-[14px] leading-loose text-justify indent-9">
        <p>
